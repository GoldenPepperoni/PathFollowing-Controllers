...
custom_targets = [[0, 250, 10]]
custom_yaw_targets = [np.pi/2] # (-pi to pi)

# Create and initialise dubins path env
envs = gymnasium.make("PyFlyt/Fixedwing-NLGLDubinsPath-v0", spawn_pos=np.array([[5, 5, 10]]), render_mode=None, angle_representation="euler", flight_dome_size=500, turning_radius=50, num_targets=len(custom_yaw_targets), custom_targets=custom_targets, custom_yaw_targets=custom_yaw_targets, NLGL_L1=L1)
