...
envs = gymnasium.make("PyFlyt/Fixedwing-DubinsPath-v0", render_mode=None, angle_representation="euler", flight_dome_size=200, turning_radius=50, num_targets=len(custom_yaw_targets), custom_targets=custom_targets, custom_yaw_targets=custom_yaw_targets)
